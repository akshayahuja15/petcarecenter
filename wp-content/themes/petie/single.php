        ...
        <div id="primary" class="content-area">
            <main id="main" class="site-main">
                ...
                while (have_posts()) : the_post();
                    ...
                    $obj = petie_get_post_link('category', 'post');
                        ...
                        <div class="navigation">
                            <?php if (!empty($prev_link)): ?>
                                <div class="previous-nav">
                                    <div class="nav-content">
                                        ...
                                        <div class="nav-link">
                                            <div class="nav-title"><?php esc_html_e('Previous Post', 'petie'); ?></div>
                            ...
                            <?php if (!empty($next_link)): ?>
                                <div class="next-nav">
                                    <div class="nav-content">
                                        <div class="nav-link">
                                            <div class="nav-title"><?php esc_html_e('Next Post', 'petie'); ?></div>
                    ...
                    if (is_active_sidebar('sidebar-single-post') || (!class_exists('PetieCore') && is_active_sidebar('sidebar-blog'))) {
                        petie_fnc_related_post(2);
                    } else {
                        petie_fnc_related_post(3);
                    }
