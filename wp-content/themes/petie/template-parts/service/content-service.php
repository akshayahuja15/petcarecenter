...
if (has_post_thumbnail()) {
    $thumbnail_url = get_the_post_thumbnail_url(get_the_ID(), 'petie-featured-image-large');
} else {
    $thumbnail_url = petie_get_placeholder_image();
}
...
<article <?php post_class('osf-service-article column-item'); ?>>
    <div class="osf-service-article-inner">
        ...
        <div class="service-link-more">
            ...
            <a href="<?php the_permalink(); ?>">
                <span class="screen-reader-text"><?php esc_html_e('Explore', 'petie'); ?></span>
